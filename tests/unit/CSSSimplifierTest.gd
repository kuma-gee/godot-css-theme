...
func test_map_classes():
	var theme = create_theme_from_text("Button.test {color: #333} Label.test {color: #333}")
	assert_eq(theme.get_color("font_color", "ButtonTest"), Color("#333"))
	assert_eq(theme.get_color("font_color", "LabelTest"), Color("#333"))
